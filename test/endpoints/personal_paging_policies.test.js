...
describe('Personal Paging Policies Endpoint Tests', () => {
  ...
  context('#createPolicyStepRule()', () => {
    ...
    it(`should throw an error when creating a rule for a paging ` +
      `policy step`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
  ...
  context('#deletePolicyStepRule()', () => {
    ...
    it(`should throw an error when deleting a rule for a paging ` +
      `policy step`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
  ...
  context('#getPolicyStepRule()', () => {
    ...
    it(`should throw an error when getting a rule for a paging ` +
      `policy step`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
  ...
  context('#updatePolicyStepRule()', () => {
    ...
    it(`should throw an error when updating a rule for a paging ` +
      `policy step`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
