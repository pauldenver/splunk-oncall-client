...
describe('Scheduled Overrides Endpoint Tests', () => {
  ...
  context('#getAssignments()', () => {
    ...
    it(`should throw an error when getting scheduled override ` +
      `assignments`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
  ...
  context('#deleteAssignment()', () => {
    ...
    it(`should throw an error when deleting a scheduled override ` +
      `assignment`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
        .delete('/api-public/v1/overrides/another-override/' +
          'assignments/another-policy')
        .replyWithError('Something bad happened!');
  ...
  context('#getAssignment()', () => {
    ...
    it(`should throw an error when getting a scheduled override ` +
      `assignment`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
  ...
  context('#updateAssignment()', () => {
    ...
    it(`should throw an error when updating a scheduled override ` +
      `assignment`, async () => {
      // Mock the API request.
      nock(baseUrl, reqHeaders)
